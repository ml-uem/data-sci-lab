...
class SingleLayerNeuralNetwork(ModelInterface):
    ...
    def fit(self, X, y):
        ...
        for i in range(0, self._num_iterations):
            ...
            self._parameters = { 
                "W1": Utils().GradientDescent(W1, self._learning_rate, grads["dW1"]), 
                "W2": Utils().GradientDescent(W2, self._learning_rate, grads["dW2"]),
                "b1": Utils().GradientDescent(b1, self._learning_rate, grads["dB1"]),
                "b2": Utils().GradientDescent(b2, self._learning_rate, grads["dB2"]),
            }
